...
public:
  ...
  /*! \brief Sample outcomes from a realisation of the posterior distribution.
   *
   ...
   *
   * \return A vector of outcomes observed from the resulting stochastic
   * process.
   */
  std::vector<Outcome> sample(int n, std::mt19937 *engine = nullptr);

  /*! \brief Sample possible full observation sets from the posterior using
   * observed outcomes.
   *
